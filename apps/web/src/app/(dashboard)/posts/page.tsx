...
const MOCK_POSTS: Post[] = [
  {
    ...
    content: 'Exciting news! We\'re thrilled to announce the launch of our new product line this spring. Stay tuned for more details!',
  ...
  },
  {
    ...
    clientId: 'c5',
    clientName: 'Echo Commerce',
    createdAt: '2026-03-10T14:30:00Z',
  },
  {
    id: 'p3',
    title: 'Behind the Scenes: Our Design Process',
    content: 'Ever wonder how we create award-winning designs? Take a peek inside our creative studio and meet the team.',
    platforms: ['instagram', 'tiktok'],
    status: 'scheduled',
    scheduledAt: '2026-03-22T14:00:00Z',
    clientId: 'c2',
    clientName: 'Bright Ideas Studio',
  ...
  },
  {
    ...
    scheduledAt: null,
    clientId: 'c3',
    clientName: 'CloudSync Systems',
    createdAt: '2026-03-14T11:00:00Z',
  },
  {
    id: 'p5',
    title: 'Patient Wellness Tips — March Edition',
    content: 'March is National Nutrition Month! Here are our top 5 tips for maintaining a balanced diet and healthy lifestyle.',
    platforms: ['facebook', 'instagram'],
    status: 'published',
    scheduledAt: '2026-03-05T08:00:00Z',
    clientId: 'c4',
    clientName: 'Delta Health Partners',
    createdAt: '2026-03-01T10:00:00Z',
  },
  {
    id: 'p6',
    title: 'New Feature: Real-time Analytics Dashboard',
    content: 'We just shipped the most requested feature of 2026 — a fully real-time analytics dashboard. Check it out now!',
    platforms: ['twitter', 'linkedin'],
    status: 'scheduled',
    scheduledAt: '2026-03-25T16:00:00Z',
    clientId: 'c8',
    clientName: 'Harbor Analytics',
    createdAt: '2026-03-15T13:45:00Z',
  },
  {
    id: 'p7',
    title: 'Spring Fitness Challenge — Week 1',
    content: 'Ready to crush your fitness goals? Join our 8-week Spring Challenge starting Monday. Tag a friend to join you!',
    platforms: ['instagram', 'tiktok', 'youtube'],
    status: 'scheduled',
    scheduledAt: '2026-03-18T07:00:00Z',
    clientId: 'c15',
    clientName: 'Olympus Fitness',
    createdAt: '2026-03-10T16:00:00Z',
  },
  {
    id: 'p8',
    title: 'Legal Tip Tuesday: Know Your Rights',
    content: 'This week we\'re covering tenant rights in commercial leases. What you need to know before signing anything.',
    platforms: ['linkedin', 'facebook'],
    status: 'failed',
    scheduledAt: '2026-03-11T12:00:00Z',
    clientId: 'c9',
    clientName: 'Ironclad Legal',
    createdAt: '2026-03-09T10:00:00Z',
  },
  {
    id: 'p9',
    title: 'New Collection Drop — Spring Botanicals',
    content: 'Introducing our Spring Botanicals collection! Infused with rose, chamomile, and lavender. Shop the drop now.',
    platforms: ['instagram', 'tiktok'],
    status: 'draft',
    scheduledAt: null,
    clientId: 'c10',
    clientName: 'Jasmine Beauty Co.',
    createdAt: '2026-03-13T15:30:00Z',
  },
  {
    id: 'p10',
    title: 'Property of the Week: Downtown Penthouse',
    content: 'Stunning 3-bedroom penthouse in the heart of downtown. Floor-to-ceiling windows, private rooftop terrace. DM for tour.',
    platforms: ['instagram', 'facebook'],
    status: 'published',
    scheduledAt: '2026-03-08T10:00:00Z',
    clientId: 'c11',
    clientName: 'Keystone Realty',
    createdAt: '2026-03-06T09:00:00Z',
  },
  {
    id: 'p11',
    title: 'Fintech Insight: Open Banking in 2026',
    content: 'Open banking is no longer the future — it\'s the present. Learn how our platform leverages open APIs to deliver superior UX.',
    platforms: ['linkedin', 'twitter'],
    status: 'scheduled',
    scheduledAt: '2026-03-26T11:00:00Z',
    clientId: 'c12',
    clientName: 'Luminary Fintech',
    createdAt: '2026-03-16T14:00:00Z',
  },
  {
    id: 'p12',
    title: 'Earth Day Event Recap',
    content: 'What an incredible Earth Day celebration! Over 500 attendees, 12 local vendors, and so much good energy. See you next year!',
    platforms: ['facebook', 'instagram', 'twitter'],
    status: 'published',
    scheduledAt: '2026-03-03T18:00:00Z',
    clientId: 'c13',
    clientName: 'Metro Event Group',
    createdAt: '2026-03-03T20:00:00Z',
  },
  {
    id: 'p13',
    title: 'Dev Tip: TypeScript 5.x Best Practices',
    content: 'TypeScript 5 brought huge DX improvements. Here are our top picks from the new features that every dev should be using.',
    platforms: ['twitter', 'linkedin'],
    status: 'cancelled',
    scheduledAt: '2026-03-07T09:00:00Z',
    clientId: 'c14',
    clientName: 'NorthWave Software',
    createdAt: '2026-03-04T11:00:00Z',
  },
  {
    id: 'p14',
    title: 'Investor Update Q1 2026',
    content: 'We are proud to share our Q1 2026 results with the community. Growth is strong across all verticals. Full report linked.',
    platforms: ['linkedin'],
    status: 'draft',
    scheduledAt: null,
    clientId: 'c6',
    clientName: 'Founders Launchpad',
    createdAt: '2026-03-17T10:00:00Z',
  },
  {
    id: 'p15',
    title: 'Recipe of the Week: Spring Grain Bowl',
    content: 'Fuel your week with our signature spring grain bowl featuring quinoa, roasted beets, edamame, and tahini dressing.',
    platforms: ['instagram', 'facebook', 'tiktok'],
    status: 'scheduled',
    scheduledAt: '2026-03-24T12:00:00Z',
    clientId: 'c7',
  ...
  {
    id: 'p16',
    title: 'Webinar Reminder: AI for Marketers',
    content: 'Don\'t forget — our free webinar on using AI in your marketing workflow is tomorrow at 2 PM EST. Register now!',
    platforms: ['twitter', 'linkedin', 'facebook'],
    status: 'scheduled',
  ...
  {
    id: 'p17',
    title: 'User Spotlight: Success Story',
    content: 'Meet @sarahj, who grew her online store 3× in just 6 months using our platform. Read her full story on our blog.',
  ...
  {
    id: 'p18',
    title: 'TikTok Trend Alert: The #CleanBeauty Challenge',
    content: 'We\'re joining the #CleanBeauty challenge! Share your clean beauty routine and tag us for a chance to be featured.',
