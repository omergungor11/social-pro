...
2. `sp-docs/MEMORY.md` oku — kalici hafiza, teknik kararlar, ogrenilen pattern'ler
3. `sp-tasks/task-index.md` oku — dashboard + tum task durumlari
4. `sp-tasks/active/session-notes.md` oku — onceki session notlari
